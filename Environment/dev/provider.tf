...
backend "azurerm" {
  resource_group_name =  "demo-GA-dev"
  storage_account_name = "demogastgdev1"                              # Can be passed via `-backend-config=`"storage_account_name=<storage account name>"` in the `init` command.
